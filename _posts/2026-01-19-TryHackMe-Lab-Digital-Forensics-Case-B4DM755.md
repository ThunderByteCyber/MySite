...
description: This write‑up documents my approach to a simulated digital forensics and incident response (DFIR) investigation based on the TryHackMe – Digital Forensics Case: B4DM755 lab.
tags:
- Digital
- FTK
- Forensics
